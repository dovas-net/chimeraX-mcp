...
Standalone MCP server connecting Claude Code CLI to UCSF ChimeraX for molecular visualization and structural analysis. 48 tools covering structure management, visualization, analysis, measurement, sequence, editing, volume/surface, selection, labels, surfaces, and session management.
